...
<nav class="container container--70">
    ...
    <ul>
        ...
        <li><a href='<c:url value="${pageContext.request.contextPath}/mission"/>' class="btn btn--without-border">O co chodzi?</a></li>
        <li><a href='<c:url value="${pageContext.request.contextPath}/about"/>' class="btn btn--without-border">O nas</a></li>
